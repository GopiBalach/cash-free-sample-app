...
export declare class CFSubscriptionSession {
    subscription_session_id: string;
    subscription_id: string;
    environment: string;
    constructor(subscriptionSessionId: string, subscriptionId: string, environment: CFEnvironment);
}
...
export declare class CFSubscriptionCheckoutPayment implements CheckoutPayment {
    private readonly session;
    private readonly theme;
    version: string;
    constructor(session: CFSubscriptionSession, theme: CFWebTheme | null);
    getSession(): CFSubscriptionSession;
    getTheme(): CFWebTheme;
}
